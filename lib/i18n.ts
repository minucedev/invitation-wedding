  ...
  wishingWell: {
    ...
    accounts: [
      ...
      },
      {
        ...
        accountNumber: "Số TK: 9906 9077 07",
        accountName: "Chủ TK: LE VAN TUAN",
      },
    ],
...
const en: Dictionary = {
  ...
  wishingWell: {
    ...
    accounts: [
      ...
      {
        label: "Groom",
        bank: "Bank: Techcombank (TCB)",
        accountNumber: "Account No.: 9906 9077 07",
        accountName: "Account Name: LE VAN TUAN",
      },
    ],
